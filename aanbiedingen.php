...
<h1 class="a-week">Week aanbiedingen</h1>
 <div class='parent'> 
  <div class='slider'>
   ...
   <div id='slide1' class='slide1 up1'>GOLDMODE</div>
   <div id='slide2' class='slide2'>IJSKOFFIE</div>
   <div id='slide3' class='slide3'>SUGER FREE</div>
   <div id='slide4' class='slide4'>vegan</div>
  </div>
 </div>
 <footer>
